...
```bash
python3 experiments/utility-gate/btb_utility_gate.py \
  --source jsonl \
...
```bash
python3 experiments/utility-gate/btb_result_summary.py experiments/utility-gate/results/btb_utility_gate_*.json
```
...
python3 experiments/utility-gate/btb_utility_gate.py \
  ...
  --out experiments/utility-gate/results/btb_utility_gate_art_h30_replay_threshold_greedy.json
```
...
```bash
python3 experiments/utility-gate/btb_result_summary.py \
  experiments/utility-gate/results/btb_utility_gate_art_h30_replay_threshold_greedy.json \
  experiments/utility-gate/results/btb_utility_gate_art_h10_k8.json \
  experiments/utility-gate/results/btb_utility_gate_art_h30_k4.json \
  experiments/utility-gate/results/btb_utility_gate_art_h30_k8_seed37.json \
  experiments/utility-gate/results/btb_utility_gate_art_h60_k8_r1600.json
```
...
```bash
python3 experiments/utility-gate/btb_art_model_hardware_sweep.py
```
...
`experiments/utility-gate/results/art_model_hardware_sweep/`.
...
python3 experiments/utility-gate/btb_utility_gate.py \
  ...
  --horizon-s 10 \
  --max-candidates-per-window 60 \
  --out experiments/utility-gate/results/btb_utility_gate_mooncake_h10_greedy.json
```
...
python3 experiments/utility-gate/btb_utility_gate.py \
  ...
  --out experiments/utility-gate/results/btb_utility_gate_burstgpt_session_scale0005_h6_greedy.json
```
...
python3 experiments/utility-gate/btb_utility_gate.py \
  ...
  --max-candidates-per-window 60 \
  --include-cold-candidates \
  --out experiments/utility-gate/results/btb_utility_gate_qwen_traceA_blksz_16_random_h30_k32.json
```
...
python3 experiments/utility-gate/btb_utility_gate.py \
  ...
  --max-candidates-per-window 60 \
  --include-cold-candidates \
  --out experiments/utility-gate/results/btb_utility_gate_qwen_traceB_blksz_16_h10_k8.json
```
...
python3 experiments/utility-gate/btb_utility_gate.py \
  ...
  --out experiments/utility-gate/results/btb_utility_gate_qwen_thinking_blksz_16_random_h60_k32_warmcost.json
```
...
for seed in 11 37; do
  python3 experiments/utility-gate/btb_utility_gate.py \
    ...
    --threshold-grid-step 0.1 \
    --no-threshold-score-candidates \
    --out experiments/utility-gate/results/btb_utility_gate_qwen_thinking_blksz_16_random_h60_k32_warmcost_seed${seed}.json
done
```
...
```bash
python3 experiments/utility-gate/btb_result_summary.py --group-by-label \
  experiments/utility-gate/results/btb_utility_gate_qwen_thinking_blksz_16_random_h60_k32_warmcost.json \
  experiments/utility-gate/results/btb_utility_gate_qwen_thinking_blksz_16_random_h60_k32_warmcost_seed11.json \
  experiments/utility-gate/results/btb_utility_gate_qwen_thinking_blksz_16_random_h60_k32_warmcost_seed37.json
```
...
for seed in 23 11 37; do
  python3 experiments/utility-gate/btb_utility_gate.py \
    ...
    --threshold-grid-step 0.1 \
    --no-threshold-score-candidates \
    --out experiments/utility-gate/results/btb_utility_gate_qwen_thinking_blksz_16_random_h60_k32_warmcost_valid_seed${seed}.json
done
```

```bash
python3 experiments/utility-gate/btb_result_summary.py --group-by-label \
  experiments/utility-gate/results/btb_utility_gate_qwen_thinking_blksz_16_random_h60_k32_warmcost_valid_seed23.json \
  experiments/utility-gate/results/btb_utility_gate_qwen_thinking_blksz_16_random_h60_k32_warmcost_valid_seed11.json \
  experiments/utility-gate/results/btb_utility_gate_qwen_thinking_blksz_16_random_h60_k32_warmcost_valid_seed37.json
```
...
python3 experiments/utility-gate/btb_utility_gate.py \
  ...
  --threshold-grid-step 0.1 \
  --no-threshold-score-candidates \
  --out experiments/utility-gate/results/btb_utility_gate_qwen_coder_blksz_16_h60_k32_cost.json
```
